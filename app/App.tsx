  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Create geographically accurate plate boundaries
        const features: TopoFeature[] = [
          {
            ...
            geometry: {
              type: 'Polygon',
              coordinates: [[
                [-180, -70], [-180, 65], [-130, 60], [-103, 25], [-109, 23], 
                [-115, 32], [-125, 40], [-140, 60], [-155, 19], [-158, 22], 
                [140, 35], [150, 40], [160, 50], [170, 60], [180, 65], 
                [180, -70], [170, -60], [150, -55], [140, -60], [-70, -55], 
                [-80, -15], [-103, 25], [-180, -70]
              ]]
            }
          },
          {
            ...
            geometry: {
              type: 'Polygon',
              coordinates: [[
                [-130, 60], [-103, 25], [-109, 23], [-115, 32], [-125, 40], 
                [-83, 24], [-72, 36], [-69, 44], [-67, 47], [-141, 69], 
                [-130, 60]
              ]]
            }
          },
          {
            ...
            geometry: {
              type: 'Polygon',
              coordinates: [[
                [-109, 23], [-83, 24], [-72, 36], [-34, 7], [-37, -7], 
                [-39, -18], [-71, -55], [-80, -15], [-109, 23]
              ]]
            }
          },
          {
            ...
            geometry: {
              type: 'Polygon',
              coordinates: [[
                [-30, 36], [26, 71], [142, 71], [140, 35], [92, 5], 
                [58, 25], [35, 25], [24, 35], [-8, 35], [-30, 36]
              ]]
            }
          },
          {
            ...
            geometry: {
              type: 'Polygon',
              coordinates: [[
                [-30, 36], [-8, 35], [24, 35], [35, 25], [58, 25], 
                [43, -16], [30, -29], [17, -34], [-5, -16], [-17, 14], 
                [-30, 36]
              ]]
            }
          },
          {
            ...
            geometry: {
              type: 'Polygon',
              coordinates: [[
                [58, 25], [92, 5], [140, 35], [150, 40], [160, 50], 
                [155, -8], [145, -20], [125, -50], [95, -35], [78, -10], 
                [58, 25]
              ]]
            }
          },
          {
            ...
            geometry: {
              type: 'Polygon',
              coordinates: [[
                [-180, -90], [-180, -55], [-71, -55], [-39, -18], 
                [17, -34], [30, -29], [125, -50], [145, -20], 
                [170, -60], [180, -70], [180, -90], [-180, -90]
              ]]
            }
          }
        ];
